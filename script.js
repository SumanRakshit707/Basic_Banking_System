 ...
 var enterSName = document.getElementById("enterSName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
    ...
    if (enterAmount > enterSAmount) {
       ...
       var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender ${enterSName} with Email-id ${enterSName}@email.com
to recepient ${enterName} with Email-id ${enterName}@email.com on ${Date()}.`);
